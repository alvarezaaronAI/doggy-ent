...
<template>
  <Teleport to="body">
    ...
    >
      ...
      >
        <div class="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-[color-mix(in_srgb,var(--brand-2)_40%,white)] text-2xl text-[var(--brand-4)]">
          🛍️
        </div>
      ...
      <div v-else class="flex min-h-0 flex-1 flex-col">
        <div class="min-h-0 flex-1 space-y-5 overflow-y-auto px-5 py-5">
          <article
            ...
            class="tile rounded-2xl p-4"
          >
            <div class="flex gap-4">
              <img
                class="h-20 w-20 flex-shrink-0 rounded-2xl border border-stone-800 object-cover"
                :src="item.image"
                :alt="item.name"
              />
              ...
              <div class="min-w-0 flex-1">
                <div class="flex items-start justify-between gap-3">
                  ...
                  <button
                    class="text-stone-400 hover:text-emerald-400"
                ...
                <div class="mt-4 flex items-center justify-between gap-3">
                  <div class="inline-flex items-center overflow-hidden rounded-full border border-stone-700">
                    <button
        ...
        <div class="border-t border-stone-800 bg-[color-mix(in_srgb,var(--brand-5)_55%,white)] px-5 py-5">
