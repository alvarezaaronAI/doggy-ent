                  ...
                  <div class="min-w-0 flex-1">
                    <div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                      <div>
                        ...
                        <p class="mt-1 text-sm text-stone-400">{{ formatPrice(item.unitPrice) }} × {{ item.quantity }}</p>
                      </div>
          ...
          <div class="grid gap-6 md:grid-cols-2">
            <section class="rounded-2xl border border-[var(--brand-3)] bg-white p-5 shadow-sm">
              ...
              <div class="mt-3 space-y-2 text-sm">
                ...
                <p><span class="font-semibold text-stone-400">Status:</span> {{ order.status }}</p>
                <p><span class="font-semibold text-stone-400">Order Number:</span> {{ order.orderNumber }}</p>
              </div>
            </section>
          </div>
        </div>
